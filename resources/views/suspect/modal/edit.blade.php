    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-edit"></i>&nbsp;Edit Tersangka</h5>
            ...
            <form method="post" action="{{ route('suspect.update', $suspect->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="name_{{ $suspect->id }}">Nama <span class="text-danger">*</span></label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="gender_{{ $suspect->id }}">Jenis Kelamin <span class="text-danger">*</span></label>
                            <select class="form-control @error('gender') is-invalid @enderror" id="gender_{{ $suspect->id }}" name="gender" required>
                                <option value="">-- Pilih Jenis Kelamin --</option>
                                <option value="Male" {{ old('gender', $suspect->gender) == 'Male' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="Female" {{ old('gender', $suspect->gender) == 'Female' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                            @error('gender')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="place_of_birth_{{ $suspect->id }}">Tempat Lahir</label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="date_of_birth_{{ $suspect->id }}">Tanggal Lahir</label>
                    ...
                    <div class="form-group">
                        <label for="address_{{ $suspect->id }}">Alamat</label>
                            ...
                            @foreach($suspect->cases as $caseIndex => $case)
                                <div class="card case-card mb-3">
                                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                        <span><strong>Kasus #{{ $caseIndex + 1 }}</strong></span>
...
{{--                                        </div>--}}
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i>&nbsp;Update Tersangka</button>
                </div>
            </form>
        </div>
    </div>
